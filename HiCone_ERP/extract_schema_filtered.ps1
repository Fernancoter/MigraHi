...
$files = Get-ChildItem -Path $entitiesDir -Recurse -Filter "*.cs" | Where-Object {
    $_.FullName -match "\\Inventario\\" -or
    $_.Name -match "Extru" -or
    $_.Name -match "Bobina" -or
    $_.Name -match "Silo" -or
    $_.Name -match "Existencia" -or
    $_.Name -match "Articulo"
}
...
$output | Out-File -Encoding utf8 "C:\KBs\HiCone6\HiCone_ERP\schema_mermaid_filtered.txt"
Write-Host "Done"
