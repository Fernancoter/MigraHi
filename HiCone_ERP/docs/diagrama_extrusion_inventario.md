# Diagrama de Base de Datos - Extrusión e Inventario

A continuación se muestra el diagrama Entidad-Relación enfocado exclusivamente en los módulos de Extrusión e Inventario:
