        ...
        <div class="toolbar-premium">
          ...
          <div class="toolbar-right">
            ...
            <div class="search-underline-box">
              <input type="text" class="search-input-underline" placeholder="Buscar" [(ngModel)]="searchQuery" (input)="cdr.detectChanges()">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="modal-overlay-premium" *ngIf="showModal" (click)="closeModal()">
        <div class="modal-card-premium animate-scale-in" style="max-width: 800px;" (click)="$event.stopPropagation()">
          <div class="modal-header-premium">
            <h3><span>📂</span> {{ modalMode === 'VIEW' ? 'Visualizar Silo' : modalMode === 'EDIT' ? 'Modificar Silo' : modalMode === 'DELETE' ? 'Eliminar Silo' : modalMode === 'CONSUMO' ? 'Registrar Salida' : 'Agregar Silo' }}</h3>
            ...
            <div class="modal-body-premium custom-scroll" [style.max-height]="'60vh'" [style.overflow-y]="'auto'">
              ...
              <ng-container *ngIf="modalMode === 'CONSUMO'">
                <div class="form-group-premium" style="grid-column: span 2;">
                  <label>Existencia Actual (kg)</label>
                  <input type="number" class="input-premium" [value]="newSilo.existenciaActual" disabled>
                </div>
                <div class="form-group-premium">
                  <label>Kilos a Descontar *</label>
                  <input type="number" class="input-premium" [(ngModel)]="consumoKilos" name="consumoKilos" required min="0.01" [max]="newSilo.existenciaActual || 0">
                </div>
                <div class="form-group-premium">
                  <label>Motivo *</label>
                  <input type="text" class="input-premium" [(ngModel)]="consumoMotivo" name="consumoMotivo" required placeholder="Ej. Consumo por Extrusión">
                </div>
              </ng-container>
              ...
              <ng-container *ngIf="modalMode !== 'CONSUMO' && (modalMode !== 'VIEW' || activeTab === 'details')">
                ...
                <div class="form-group-premium">
                  <label>Código *</label>
                  <input type="text" class="input-premium" [(ngModel)]="newSilo.codigo" name="codigo" required [disabled]="modalMode === 'VIEW' || modalMode === 'DELETE'">
                </div>

                <div class="form-group-premium">
                  <label>Nombre *</label>
                  <input type="text" class="input-premium" [(ngModel)]="newSilo.nombre" name="nombre" required [disabled]="modalMode === 'VIEW' || modalMode === 'DELETE'">
                </div>

                <div class="form-group-premium">
                  <label>Capacidad (kg)</label>
                  <input type="number" class="input-premium" [(ngModel)]="newSilo.capacidadMaxima" name="capacidad" [disabled]="modalMode === 'VIEW' || modalMode === 'DELETE'">
                </div>

                <div class="form-group-premium">
                  <label>Mínimo (kg)</label>
                  <input type="number" class="input-premium" [(ngModel)]="newSilo.kgMinimo" name="minimo" [disabled]="modalMode === 'VIEW' || modalMode === 'DELETE'">
                </div>

                <div class="form-group-premium">
                  <label>Máximo (kg)</label>
                  <input type="number" class="input-premium" [(ngModel)]="newSilo.kgMaximo" name="maximo" [disabled]="modalMode === 'VIEW' || modalMode === 'DELETE'">
                </div>

                <div class="form-group-premium">
                  <label>Estado Material</label>
                  <select class="input-premium" [(ngModel)]="newSilo.estadoMaterial" name="estadoMat" [disabled]="modalMode === 'VIEW' || modalMode === 'DELETE'">
                ...
                <div class="form-group-premium">
                  ...
                  <select class="input-premium" [(ngModel)]="newSilo.tipoMaterial" name="tipoMat" [disabled]="modalMode === 'VIEW' || modalMode === 'DELETE'">
                ...
                <div class="form-group-premium" style="flex-direction: row; align-items: center; gap: 0.5rem;">
                  <input type="checkbox" class="legacy-checkbox" id="chk-activo" [(ngModel)]="newSilo.activo" name="activo" [disabled]="modalMode !== 'ADD'">
                  <label for="chk-activo" style="margin: 0; cursor: pointer;">Activo</label>
                </div>
              </ng-container>
