    ...
    <aside class="sidebar-dynamic shadow-right" [class.mini-mode]="!(isSidebarVisible$ | async)">
      ...
      <nav class="sidebar-nav">
        ...
        <ng-container *ngIf="(activeModule$ | async) === 'CALIDAD'">
          ...
          <a routerLink="/calidad" routerLinkActive="active" class="nav-item" title="Control de Calidad">
            <div class="item-icon"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg></div>
            <span class="item-label">Control de Calidad</span>
          </a>
        </ng-container>
