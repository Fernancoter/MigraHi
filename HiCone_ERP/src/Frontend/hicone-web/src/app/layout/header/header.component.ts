...
export class HeaderComponent {
  ...
  modules: ModuleItem[] = [
    { title: 'Inventario', icon: '🏭', route: '/inventario/existencias' },
    { title: 'Lotes', icon: '📦', route: '/inventario/lotes' },
    ...
    { title: 'Cierre de Mes', icon: '📆', route: '/inventario/cierre-mes' },
  ...
  selectModule(module: ModuleItem) {
    ...
    // Mapeo de títulos a tipos de módulo
    if (['Inventario', 'Lotes', 'Cierre de Mes'].includes(module.title)) {
      this.navService.setActiveModule('INVENTARIO');
    } else if (['Extrusión', 'Prensado'].includes(module.title)) {
