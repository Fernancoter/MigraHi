...
- **Entry point:** [Embarque](../Transactions/DB/Embarque.md) -- tipo externo (no navegable desde el menú)
- **Invocado cross-module desde:** `Embarques.BuscarEmbarqueRemission`, `Embarques.CargarEmbarque`, `Embarques.ComenzarCargaDeEmbarque`
- **Módulo principal:** `DB`
- **Objetos en el proceso:** 77
- **Módulos tocados:** `DB`, `Embarques`, `GeneXus.Server`, `Informes`, `Produccion`, `WWPBaseObjects`, `WWPBaseObjects.Mail`, `WWPBaseObjects.Notifications.Common`, `WWPBaseObjects.Notifications.Web`, `WWPBaseObjects.SMS`, `WWPBaseObjects.Subscriptions`
- **Mergeado con:** `InicializarEmbarque` _(≥80 % overlap)_

## Narrativa

*(pendiente -- se completa en la pasada de narrativa posterior sobre `proc_db_embarque.prompt.txt`)*

## Objetos (call trace ordenado por depth)

- depth 0: [Embarque](../Transactions/DB/Embarque.md) (`Transaction`, `DB`)
- depth 0: [InicializarEmbarque](../Procedures/Embarques/InicializarEmbarque.md) (`Procedure`, `Embarques`)
...
- depth 1: [LoadAuditEmbarque](../Procedures/DB/LoadAuditEmbarque.md) (`Procedure`, `DB`)
- depth 1: [Order](../Transactions/DB/Order.md) (`Transaction`, `DB`)
- depth 1: [Remission](../Transactions/DB/Remission.md) (`Transaction`, `DB`)
- depth 1: [BuscarEmbarqueRemission](../Procedures/Embarques/BuscarEmbarqueRemission.md) (`Procedure`, `Embarques`)
- depth 1: [EmbarqueWP](../WebPanels/Embarques/EmbarqueWP.md) (`WebPanel`, `Embarques`)
- depth 1: [ObtenerDatosRemisionDesdeSAE](../Procedures/Embarques/ObtenerDatosRemisionDesdeSAE.md) (`Procedure`, `Embarques`)
- depth 1: [ObtenerFechaRemisionDesdeSAE](../Procedures/Embarques/ObtenerFechaRemisionDesdeSAE.md) (`Procedure`, `Embarques`)
- depth 1: [TotalPalletPorProductNumber](../Procedures/Informes/TotalPalletPorProductNumber.md) (`Procedure`, `Informes`)
...
- depth 2: [ListadoEmbarques](../WebPanels/Embarques/ListadoEmbarques.md) (`WebPanel`, `Embarques`)
...
- depth 3: [CargarEmbarque](../WebPanels/Embarques/CargarEmbarque.md) (`WebPanel`, `Embarques`)
- depth 3: [ComenzarCargaDeEmbarque](../Procedures/Embarques/ComenzarCargaDeEmbarque.md) (`Procedure`, `Embarques`)
- depth 3: [EmbarqueFormato](../WebPanels/Embarques/EmbarqueFormato.md) (`WebPanel`, `Embarques`)
- depth 3: [EmbarqueReporte](../WebPanels/Embarques/EmbarqueReporte.md) (`WebPanel`, `Embarques`)
- depth 3: [ListadoEmbarquesExport](../Procedures/Embarques/ListadoEmbarquesExport.md) (`Procedure`, `Embarques`)
- depth 3: [ListadoEmbarquesExportReport](../Procedures/Embarques/ListadoEmbarquesExportReport.md) (`Procedure`, `Embarques`)
- depth 3: [ListadoEmbarquesGetFilterData](../Procedures/Embarques/ListadoEmbarquesGetFilterData.md) (`Procedure`, `Embarques`)
...
- depth 4: [EmbarquePallet](../Transactions/DB/EmbarquePallet.md) (`Transaction`, `DB`)
- depth 4: [LlenarLoteReporte](../Procedures/Embarques/LlenarLoteReporte.md) (`Procedure`, `Embarques`)
- depth 4: [NotificarSupervisor](../Procedures/Embarques/NotificarSupervisor.md) (`Procedure`, `Embarques`)
- depth 4: [NotificationInfo](../SDTs/GeneXus/Server/NotificationInfo.md) (`SDT`, `GeneXus.Server`)
- depth 4: [InformesTelerik](../Procedures/Informes/InformesTelerik.md) (`Procedure`, `Informes`)
- depth 4: [SDTInformeFilter](../SDTs/Informes/SDTInformeFilter.md) (`SDT`, `Informes`)
- depth 4: [SDTTelerik](../SDTs/Informes/SDTTelerik.md) (`SDT`, `Informes`)
