...
- **Entry point:** [InicioProduccion](../WebPanels/Produccion/InicioProduccion.md) -- tipo menú
- **Ruta en el menú:** `Web > Producción > Inicio`
- **Módulo principal:** `Produccion`
- **Objetos en el proceso:** 9
- **Módulos tocados:** `GeneXusReporting`, `Produccion`

## Narrativa

*(pendiente -- se completa en la pasada de narrativa posterior sobre `proc_produccion_inicio_produccion.prompt.txt`)*

## Objetos (call trace ordenado por depth)

- depth 0: [InicioProduccion](../WebPanels/Produccion/InicioProduccion.md) (`WebPanel`, `Produccion`)
