# Proceso: SDPCartProductsRemove

- **Entry point:** [SDPCartProductsRemove](../Procedures/Root/SDPCartProductsRemove.md) -- tipo externo (no navegable desde el menú)
...
*(pendiente -- se completa en la pasada de narrativa posterior sobre `proc_root_sdpcart_products_remove.prompt.txt`)*

## Objetos (call trace ordenado por depth)

- depth 0: [SDPCartProductsRemove](../Procedures/Root/SDPCartProductsRemove.md) (`Procedure`, `Root`)
