# Proceso: CarreteReportMainPCR

- **Entry point:** [CarreteReportMainPCR](../Procedures/PrinterSD/CarreteReportMainPCR.md) -- tipo externo (no navegable desde el menú)
...
*(pendiente -- se completa en la pasada de narrativa posterior sobre `proc_printer_sd_carrete_report_main_pcr.prompt.txt`)*

## Objetos (call trace ordenado por depth)

- depth 0: [CarreteReportMainPCR](../Procedures/PrinterSD/CarreteReportMainPCR.md) (`Procedure`, `PrinterSD`)
