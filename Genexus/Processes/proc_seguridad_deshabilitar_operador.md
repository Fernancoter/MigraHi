# Proceso: DeshabilitarOperador

- **Entry point:** [DeshabilitarOperador](../Procedures/Seguridad/DeshabilitarOperador.md) -- tipo externo (no navegable desde el menú)
- **Invocado cross-module desde:** `Produccion.gestionarOperador`
...
*(pendiente -- se completa en la pasada de narrativa posterior sobre `proc_seguridad_deshabilitar_operador.prompt.txt`)*

## Objetos (call trace ordenado por depth)

- depth 0: [DeshabilitarOperador](../Procedures/Seguridad/DeshabilitarOperador.md) (`Procedure`, `Seguridad`)
