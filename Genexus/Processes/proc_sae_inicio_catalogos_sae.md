# Proceso: InicioCatalogosSAE

- **Entry point:** [InicioCatalogosSAE](../WebPanels/SAE/InicioCatalogosSAE.md) -- tipo externo (no navegable desde el menú)
...
*(pendiente -- se completa en la pasada de narrativa posterior sobre `proc_sae_inicio_catalogos_sae.prompt.txt`)*

## Objetos (call trace ordenado por depth)

- depth 0: [InicioCatalogosSAE](../WebPanels/SAE/InicioCatalogosSAE.md) (`WebPanel`, `SAE`)
