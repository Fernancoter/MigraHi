# Flujo del módulo: GeneXus.SD

> Generado por `Scripts/generate-module-flows.ps1` a partir de `_index.json` + `_menu.json` + `_processes.json` + `Modules/GeneXus.SD.md`.
...
|---|---:|---|
| `Root` | 1 | `SDPCartPaymentMethodsAddNew` |
...
- **Propósito:** Módulo con 11 objetos parseados. Sin entry points en `_menu.json` -- accedido indirectamente desde: Root.
