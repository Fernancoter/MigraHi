# Flujo del módulo: GeneXus.Social

> Generado por `Scripts/generate-module-flows.ps1` a partir de `_index.json` + `_menu.json` + `_processes.json` + `Modules/GeneXus.Social.md`.
...
- **Propósito:** TODO: definir -- módulo sin Transactions, sin entry points en el menú, y sin aristas cross-module. Revisar los 1 objetos manualmente: `FacebookAccessToken`.
