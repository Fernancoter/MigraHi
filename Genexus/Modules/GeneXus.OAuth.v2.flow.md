# Flujo del módulo: GeneXus.OAuth.v2

> Generado por `Scripts/generate-module-flows.ps1` a partir de `_index.json` + `_menu.json` + `_processes.json` + `Modules/GeneXus.OAuth.v2.md`.
...
- **Propósito:** TODO: definir -- módulo sin Transactions, sin entry points en el menú, y sin aristas cross-module. Revisar los 2 objetos manualmente: `Oauth20AccessTokenSDT`, `OAuthAuthorizationConfig`.
