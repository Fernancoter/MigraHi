# Flujo del módulo: GeneXus.SD.Media

> Generado por `Scripts/generate-module-flows.ps1` a partir de `_index.json` + `_menu.json` + `_processes.json` + `Modules/GeneXus.SD.Media.md`.
...
- **Propósito:** TODO: definir -- módulo sin Transactions, sin entry points en el menú, y sin aristas cross-module. Revisar los 8 objetos manualmente: `MediaQueue`, `ImagesCollection`, `MediaItem`, `MediaItemFinishedInfo`, `AudioPlayerSettings`.
