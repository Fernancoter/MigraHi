# Flujo del módulo: GeneXusUnanimo

> Generado por `Scripts/generate-module-flows.ps1` a partir de `_index.json` + `_menu.json` + `_processes.json` + `Modules/GeneXusUnanimo.md`.
...
- **Propósito:** TODO: definir -- módulo sin Transactions, sin entry points en el menú, y sin aristas cross-module. Revisar los 5 objetos manualmente: `SidebarItems`, `DropdownItems`, `TreeviewItems`, `StepItems`, `SelectItems`.
