# Flujo del módulo: GeneXus.SD.Notifications

> Generado por `Scripts/generate-module-flows.ps1` a partir de `_index.json` + `_menu.json` + `_processes.json` + `Modules/GeneXus.SD.Notifications.md`.
...
- **Propósito:** TODO: definir -- módulo sin Transactions, sin entry points en el menú, y sin aristas cross-module. Revisar los 1 objetos manualmente: `LocalNotificationsInfo`.
