...
Sub 'PrintData'
	...
	For each Consolidated
		...
		using DB.ConsolidatedWWDS(&FilterFullText, &TFConsolidatedName, &TFConsolidatedName_Sel)
...
Sub 'LoadGridState'
	...
	If &Session.Get(!"DB.ConsolidatedWWGridState") = !""
		&GridState.FromXml(WWPBaseObjects.LoadGridState.Udp(!"DB.ConsolidatedWWGridState"))
	Else
