...
Sub 'WriteFilters'
	...
	If not (&TFBobinaNoSerie_Sel.IsEmpty())
		WWPBaseObjects.WWP_ExportWriteFilter(&ExcelDocument, true, &CellRow, &FirstColumn, "Bobina No Serie")
	...
	If not (&TFBobinaEstado_Sels.Count = 0)
		WWPBaseObjects.WWP_ExportWriteFilter(&ExcelDocument, true, &CellRow, &FirstColumn, "Bobina Estado")
		&i = 1
...
Sub 'InitializeColumnsSelector'
	...
	WWPBaseObjects.WWP_ColumnsSelector_Add(&ColumnsSelector, !"BobinaNoSerie", '', !'Bobina No Serie', True, '')
	...
	WWP_ColumnsSelector_Add(&ColumnsSelector, !"BobinaKg", '', !'Bobina Kg', True, '')
	WWP_ColumnsSelector_Add(&ColumnsSelector, !"BobinaHoraSalida", '', !'Bobina Hora Salida', True, '')
	...
	WWPBaseObjects.WWP_ColumnsSelector_Add(&ColumnsSelector, !"PrensadoProductoId", '', !'Prensado Producto Id', True, '')
	WWPBaseObjects.WWP_ColumnsSelector_Add(&ColumnsSelector, !"PrensadoProductoNombre", '', !'Prensado Producto Nombre', True, '')
	WWPBaseObjects.WWP_ColumnsSelector_Add(&ColumnsSelector, !"PrensadoProductoTipoMaterial", '', !'Prensado Producto Tipo Material', True, '')
	WWP_ColumnsSelector_Add(&ColumnsSelector, !"PrensadoFecha", '', !'Prensado Fecha', True, '')
		
	&UserCustomValue = WWPBaseObjects.LoadColumnsSelectorState.Udp(!'DB.PrensadoBobinaWWColumnsSelector')
