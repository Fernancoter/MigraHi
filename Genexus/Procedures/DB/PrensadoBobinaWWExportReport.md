# Procedure: PrensadoBobinaWWExportReport

- **Module:** DB
- **Description:** Prensado Bobina WWExport Report
- **GAM Object:** No
...
| TFPrensadoBobinaId_To_Description | Variable | VARCHAR |  | TFPrensado Bobina Id_To_Description |
...
| TFPrensadoBobinaCantCarrera_To_Description | Variable | VARCHAR |  | TFPrensado Bobina Cant Carrera_To_Description |
...
&IsAuthorized = SecGAMIsAuthByFunctionalityKey.Udp(!'prensadobobinaww_Execute') 
If &IsAuthorized
...
Sub 'PrintFilters'
	...
	If not (&TFPrensadoBobinaId.IsEmpty() AND &TFPrensadoBobinaId_To.IsEmpty())
		print printBlockTFPrensadoBobinaId
		&TFPrensadoBobinaId_To_Description = format('%1 (%2)', "Bobina Id", "WWP_TSTo")
		print printBlockTFPrensadoBobinaId_To
	EndIf
	If not (&TFPrensadoId.IsEmpty() AND &TFPrensadoId_To.IsEmpty())
		print printBlockTFPrensadoId
		&TFPrensadoId_To_Description = format('%1 (%2)', "Prensado Id", "WWP_TSTo")
		print printBlockTFPrensadoId_To
	EndIf
	If not (&TFBobinaId.IsEmpty() AND &TFBobinaId_To.IsEmpty())
		print printBlockTFBobinaId
		&TFBobinaId_To_Description = format('%1 (%2)', "Bobina Id", "WWP_TSTo")
	...
	If not (&TFBobinaNo.IsEmpty() AND &TFBobinaNo_To.IsEmpty())
		...
		&TFBobinaNo_To_Description = format('%1 (%2)', "Bobina No", "WWP_TSTo")
	...
	If not (&TFBobinaKg.IsEmpty() AND &TFBobinaKg_To.IsEmpty())
		...
		&TFBobinaKg_To_Description = format('%1 (%2)', "Bobina Kg", "WWP_TSTo")
	...
	If not (&TFBobinaHoraSalida.IsEmpty() AND &TFBobinaHoraSalida_To.IsEmpty())
		...
		&TFBobinaHoraSalida_To_Description = format('%1 (%2)', "Bobina Hora Salida", "WWP_TSTo")
	...
	If not (&TFBobinaCarreras.IsEmpty() AND &TFBobinaCarreras_To.IsEmpty())
		...
		&TFBobinaCarreras_To_Description = format('%1 (%2)', "Bobina Carreras", "WWP_TSTo")
	...
	If not (&TFBobinaMinutosEnReposo.IsEmpty() AND &TFBobinaMinutosEnReposo_To.IsEmpty())
		...
		&TFBobinaMinutosEnReposo_To_Description = format('%1 (%2)', "Bobina Minutos En Reposo", "WWP_TSTo")
	...
	If not (&TFBobinaReposoEnHoras.IsEmpty() AND &TFBobinaReposoEnHoras_To.IsEmpty())
		...
		&TFBobinaReposoEnHoras_To_Description = format('%1 (%2)', "Tiempo Reposo (Hr)", "WWP_TSTo")
	...
	If not (&TFPrensadoBobinaCantCarrera.IsEmpty() AND &TFPrensadoBobinaCantCarrera_To.IsEmpty())
		print printBlockTFPrensadoBobinaCantCarrera
		&TFPrensadoBobinaCantCarrera_To_Description = format('%1 (%2)', "Cant Carrera", "WWP_TSTo")
		print printBlockTFPrensadoBobinaCantCarrera_To
	EndIf
	If not (&TFPrensadoOperadorId.IsEmpty() AND &TFPrensadoOperadorId_To.IsEmpty())
		print printBlockTFPrensadoOperadorId
		&TFPrensadoOperadorId_To_Description = format('%1 (%2)', "Prensado Operador Id", "WWP_TSTo")
		print printBlockTFPrensadoOperadorId_To
	EndIf
	...
	If not (&TFPrensadoPrensaId.IsEmpty() AND &TFPrensadoPrensaId_To.IsEmpty())
		print printBlockTFPrensadoPrensaId
		&TFPrensadoPrensaId_To_Description = format('%1 (%2)', "Prensa Id", "WWP_TSTo")
		print printBlockTFPrensadoPrensaId_To
	EndIf
	...
	If not (&TFPrensadoTurnoId.IsEmpty() AND &TFPrensadoTurnoId_To.IsEmpty())
		print printBlockTFPrensadoTurnoId
		&TFPrensadoTurnoId_To_Description = format('%1 (%2)', "Prensado Turno Id", "WWP_TSTo")
		print printBlockTFPrensadoTurnoId_To
	EndIf
	...
	If not (&TFPrensadoProductoId.IsEmpty() AND &TFPrensadoProductoId_To.IsEmpty())
		print printBlockTFPrensadoProductoId
		&TFPrensadoProductoId_To_Description = format('%1 (%2)', "Prensado Producto Id", "WWP_TSTo")
		print printBlockTFPrensadoProductoId_To
	EndIf
	...
	If not &TFPrensadoProductoTipoMaterial_Sels.Count = 0
		...
		For &TFPrensadoProductoTipoMaterial_Sel in &TFPrensadoProductoTipoMaterial_Sels
			If &i = 1
				&TFPrensadoProductoTipoMaterial_SelDscs = ''
			Else
				&TFPrensadoProductoTipoMaterial_SelDscs += ', '
			EndIf
			&FilterTFPrensadoProductoTipoMaterial_SelValueDescription = &TFPrensadoProductoTipoMaterial_Sel.EnumerationDescription()

			&TFPrensadoProductoTipoMaterial_SelDscs += &FilterTFPrensadoProductoTipoMaterial_SelValueDescription
			&i += 1
		EndFor
		print printBlockTFPrensadoProductoTipoMaterial_Sel
	EndIf
	If not (&TFPrensadoFecha.IsEmpty() AND &TFPrensadoFecha_To.IsEmpty())
		print printBlockTFPrensadoFecha
		&TFPrensadoFecha_To_Description = format('%1 (%2)', "Prensado Fecha", "WWP_TSTo")
...
Sub 'PrintData'
	...
	For each PrensadoBobina
		...
		&PrensadoProductoTipoMaterialDescription = PrensadoProductoTipoMaterial.EnumerationDescription()
...
Output_file("PrensadoBobinaWWExportReport","PDF");
