			...
			If &ColumnsSelector_Column.IsVisible = True
				Do Case
					...
					Case &ColumnsSelector_Column.ColumnName = !'OrderNumPar'
						&ExcelDocument.Cells(&CellRow, &FirstColumn + &VisibleColumnCount).Number = DB.OrderNumPar
					Case &ColumnsSelector_Column.ColumnName = !'ProductNumber'
						&ExcelDocument.Cells(&CellRow, &FirstColumn + &VisibleColumnCount).Text = WWP_Export_SecureText(WWPBaseObjects.Notifications.ProductNumber)
...
Sub 'InitializeColumnsSelector'
	...
	WWP_ColumnsSelector_Add(&ColumnsSelector, !"RemissionStatus", '', !'Estatus SAE', True, '')
