# Procedure: ListadoRemisionesExportReport

- **Module:** Embarques
- **Description:** Listado Remisiones Export Report
- **GAM Object:** No
...
&IsAuthorized = SecGAMIsAuthByFunctionalityKey.Udp(!'listadoremisiones_Execute') 
If &IsAuthorized
...
Sub 'PrintData'
	...
	For each DB.Remission
		...
		using ListadoRemisionesDS(&FilterFullText, &TFRemissionDate, &TFRemissionDate_To, &TFRemissionEmbarqueGenerado_Sel, &TFRemissionDoc, &TFRemissionDoc_Sel
		...
		&GridCount += 1
		&TotRemissionQuantity = RemissionQuantity + &TotRemissionQuantity
...
Sub 'PrintTotalizers'
	...
	&TotValueRemissionDate = "WWP_TotalizerCount" + trim(&GridCount.ToFormattedString())
	&TotValueRemissionQuantity = trim(&TotRemissionQuantity.ToFormattedString())
...
Output_file("ListadoRemisionesExportReport","PDF");
