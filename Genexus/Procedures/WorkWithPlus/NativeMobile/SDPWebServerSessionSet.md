# Procedure: SDPWebServerSessionSet

- **Module:** WorkWithPlus.NativeMobile
- **Description:** SDPWeb Server Session Set
- **GAM Object:** No
...
| ParameterValue | Parameter | VARCHAR | in | Parameter Value |
...
```genexus
&WebSession.Set(&ParameterKey, &ParameterValue)
```
