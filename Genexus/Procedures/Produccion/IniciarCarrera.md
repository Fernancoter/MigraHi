...
```genexus
	...
	if(&isOK)
		...
		&CarreraTroquel = &Prensado.WWPBaseObjects.Notifications.PrensadoTroquelNombre
		...
		Do while &NoLinea >= 1
			...
			&Carrete.CarreteNoSerie = CarreteNoSerie.Udp(&PrensadoId, &NoCarrera, &NoLinea)
			...
			&Carrete.WWPBaseObjects.CarretePaletSerie.SetEmpty()
