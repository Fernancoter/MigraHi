# Procedure: listarExtrusoraExportReport

- **Module:** Produccion
- **Description:** listar Extrusora Export Report
- **GAM Object:** No
...
&IsAuthorized = SecGAMIsAuthByFunctionalityKey.Udp(!'listarextrusora_Execute') 
If &IsAuthorized
...
Output_file("listarExtrusoraExportReport","PDF");
