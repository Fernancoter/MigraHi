# Procedure: listarExtrusionGetFilterData

- **Module:** Produccion
- **Description:** listar Extrusion Get Filter Data
- **GAM Object:** No
...
Do Case
	...
	Case &DDOName.ToUpper() = !'DDO_EXTRUSIONCALIBRE'
		Do 'LoadExtrusionCalibreOptions'
	Case &DDOName.ToUpper() = !'DDO_EXTRUSIONANCHO'
		Do 'LoadExtrusionAnchoOptions'
	Case &DDOName.ToUpper() = !'DDO_EXTRUSIONLONGITUD'
		Do 'LoadExtrusionLongitudOptions'
...
Sub 'LoadExtrusionCalibreOptions'

	/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */

	&TFExtrusionCalibre = &SearchTxt
	&TFExtrusionCalibre_Sel.SetEmpty()
	For Each DB.Extrusion
		Order ExtrusionCalibre
		using listarExtrusionDS(&FilterFullText, &TFExtrusionId, &TFExtrusionId_To, &TFExtrusionExtrusoraId, &TFExtrusionExtrusoraId_To, &TFExtrusionExtrusoraNombre
					, &TFExtrusionExtrusoraNombre_Sel, &TFExtrusionTurnoId, &TFExtrusionTurnoId_To, &TFExtrusionTurnoNombre, &TFExtrusionTurnoNombre_Sel, &TFExtrusionProductoId
					, &TFExtrusionProductoId_To, &TFExtrusionProductoNombre, &TFExtrusionProductoNombre_Sel, &TFExtrusionProductoTipoMaterial_Sels, &TFExtrusionFecha, &TFExtrusionFecha_To
					, &TFExtrusionCalibre, &TFExtrusionCalibre_Sel, &TFExtrusionAncho, &TFExtrusionAncho_Sel, &TFExtrusionLongitud, &TFExtrusionLongitud_Sel
		...
		For Each DB.Extrusion
			...
			&count += 1
		EndFor
		If not ExtrusionCalibre.IsEmpty()
			&Option = ExtrusionCalibre
...
Sub 'LoadExtrusionAnchoOptions'

	/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */

	&TFExtrusionAncho = &SearchTxt
	&TFExtrusionAncho_Sel.SetEmpty()
	For Each DB.Extrusion
		Order ExtrusionAncho
		using listarExtrusionDS(&FilterFullText, &TFExtrusionId, &TFExtrusionId_To, &TFExtrusionExtrusoraId, &TFExtrusionExtrusoraId_To, &TFExtrusionExtrusoraNombre
					, &TFExtrusionExtrusoraNombre_Sel, &TFExtrusionTurnoId, &TFExtrusionTurnoId_To, &TFExtrusionTurnoNombre, &TFExtrusionTurnoNombre_Sel, &TFExtrusionProductoId
					, &TFExtrusionProductoId_To, &TFExtrusionProductoNombre, &TFExtrusionProductoNombre_Sel, &TFExtrusionProductoTipoMaterial_Sels, &TFExtrusionFecha, &TFExtrusionFecha_To
					, &TFExtrusionCalibre, &TFExtrusionCalibre_Sel, &TFExtrusionAncho, &TFExtrusionAncho_Sel, &TFExtrusionLongitud, &TFExtrusionLongitud_Sel
		...
		For Each DB.Extrusion
			...
			&count += 1
		EndFor
		If not ExtrusionAncho.IsEmpty()
			&Option = ExtrusionAncho
...
Sub 'LoadExtrusionLongitudOptions'

	/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */

	&TFExtrusionLongitud = &SearchTxt
	&TFExtrusionLongitud_Sel.SetEmpty()
	For Each DB.Extrusion
		Order ExtrusionLongitud
		using listarExtrusionDS(&FilterFullText, &TFExtrusionId, &TFExtrusionId_To, &TFExtrusionExtrusoraId, &TFExtrusionExtrusoraId_To, &TFExtrusionExtrusoraNombre
					, &TFExtrusionExtrusoraNombre_Sel, &TFExtrusionTurnoId, &TFExtrusionTurnoId_To, &TFExtrusionTurnoNombre, &TFExtrusionTurnoNombre_Sel, &TFExtrusionProductoId
					, &TFExtrusionProductoId_To, &TFExtrusionProductoNombre, &TFExtrusionProductoNombre_Sel, &TFExtrusionProductoTipoMaterial_Sels, &TFExtrusionFecha, &TFExtrusionFecha_To
					, &TFExtrusionCalibre, &TFExtrusionCalibre_Sel, &TFExtrusionAncho, &TFExtrusionAncho_Sel, &TFExtrusionLongitud, &TFExtrusionLongitud_Sel
		...
		For Each DB.Extrusion
			...
			&count += 1
		EndFor
		If not ExtrusionLongitud.IsEmpty()
			&Option = ExtrusionLongitud
...
Sub 'LoadExtrusionOperadorNombreOptions'
	...
	For Each DB.Extrusion
		...
		For Each DB.Extrusion
			...
			&count += 1
		EndFor
		If not DB.ExtrusionOperadorNombre.IsEmpty()
