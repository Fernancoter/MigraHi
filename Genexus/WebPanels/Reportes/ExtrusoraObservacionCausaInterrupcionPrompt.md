# WebPanel: ExtrusoraObservacionCausaInterrupcionPrompt
...
| InExtrusoraObservacionId | Variable | NUMERIC |  | In Extrusora Observacion Id |
...
parm(In:&InExtrusoraObservacionId, InOut:&InOutCausaInterrupcionId);
