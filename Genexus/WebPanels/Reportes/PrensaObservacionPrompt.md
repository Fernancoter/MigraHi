# WebPanel: PrensaObservacionPrompt

- **Module:** Reportes
- **Description:** Select Prensa Observacion
- **GAM Object:** No
...
| InOutPrensaObservacionId | Variable | NUMERIC |  | In Out Prensa Observacion Id |
| InOutPrensaObservacionFecha | Variable | DATE |  | In Out Prensa Observacion Fecha |
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	...
	Form.Caption = 'Select Prensa Observacion'
	If &OrderedBy < 1
		&OrderedBy = 1
...
```genexus
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	&InOutPrensaObservacionId = PrensaObservacionId
	&InOutPrensaObservacionFecha = PrensaObservacionFecha
	Return
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
...
parm(InOut:&InOutPrensaObservacionId, InOut:&InOutPrensaObservacionFecha);
