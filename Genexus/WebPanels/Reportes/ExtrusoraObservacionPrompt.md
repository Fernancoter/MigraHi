# WebPanel: ExtrusoraObservacionPrompt

- **Module:** Reportes
- **Description:** Select Extrusora Observacion
- **GAM Object:** No
...
| InOutExtrusoraObservacionId | Variable | NUMERIC |  | In Out Extrusora Observacion Id |
| InOutExtrusoraObservacionFecha | Variable | DATE |  | In Out Extrusora Observacion Fecha |
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	...
	Form.Caption = 'Select Extrusora Observacion'
	If &OrderedBy < 1
		&OrderedBy = 1
...
```genexus
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	&InOutExtrusoraObservacionId = ExtrusoraObservacionId
	&InOutExtrusoraObservacionFecha = ExtrusoraObservacionFecha
	Return
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
...
parm(InOut:&InOutExtrusoraObservacionId, InOut:&InOutExtrusoraObservacionFecha);
