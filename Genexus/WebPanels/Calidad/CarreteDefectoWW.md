...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	...
	If (&IsAuthorized_Update)
		&Update.Link = CarreteDefecto.Link(TrnMode.Update, CarreteDefectoId)
	Endif
	...
	If (&IsAuthorized_CarreteDefectoNombre)
		CarreteDefectoNombre.Link = Calidad.CarreteDefectoView.Link(CarreteDefectoId, '')
	Endif
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	If (&IsAuthorized_Insert)
		Calidad.CarreteDefecto.Call(TrnMode.Insert, nullvalue(CarreteDefectoId))
	Else
