# WebPanel: DownTimeCodePrompt

- **Module:** Downtime
- **Description:** Select Down Time Code
- **GAM Object:** No
...
| InOutDownTimeCodeId | Variable | VARCHAR |  | In Out Down Time Code Id |
| InOutDownTimeCodeName | Variable | VARCHAR |  | In Out Down Time Code Name |
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	...
	Form.Caption = 'Select Down Time Code'
	If &OrderedBy < 1
		&OrderedBy = 1
...
```genexus
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	&InOutDownTimeCodeId = DownTimeCodeId
	&InOutDownTimeCodeName = DownTimeCodeName
	Return
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
...
parm(InOut:&InOutDownTimeCodeId, InOut:&InOutDownTimeCodeName);
