...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	...
	If &Session.Get(!'Embarques.OrdenesWWColumnsSelector') <> ''
		&ColumnsSelectorXML = &Session.Get(!'Embarques.OrdenesWWColumnsSelector')
		&ColumnsSelector.FromXml(&ColumnsSelectorXML)
	Else
		Do 'InitializeColumnsSelector'
	EndIf
	OrderDoc.Visible = &ColumnsSelector.Columns.Item(1).IsVisible
	OrderNumPar.Visible = &ColumnsSelector.Columns.Item(2).IsVisible
	ProductNumber.Visible = &ColumnsSelector.Columns.Item(3).IsVisible
	ProductType.Visible = &ColumnsSelector.Columns.Item(4).IsVisible
	ProductDesc.Visible = &ColumnsSelector.Columns.Item(5).IsVisible
	Customer.Visible = &ColumnsSelector.Columns.Item(6).IsVisible
	CustomerName.Visible = &ColumnsSelector.Columns.Item(7).IsVisible
	ConsolidatedName.Visible = &ColumnsSelector.Columns.Item(8).IsVisible
	OrderKey.Visible = &ColumnsSelector.Columns.Item(9).IsVisible
	OrderDate.Visible = &ColumnsSelector.Columns.Item(10).IsVisible
	OrderDeliveryDate.Visible = &ColumnsSelector.Columns.Item(11).IsVisible
	...
	OrderShipping.Visible = &ColumnsSelector.Columns.Item(17).IsVisible
	...
	Do Case
		...
		Case DDO_Grid.ActiveEventKey = !'<#Filter#>'
			Do Case
				...
				Case DDO_Grid.SelectedColumn = !'OrderStatus'
					&TFOrderStatus = DDO_Grid.FilteredText_get
					&TFOrderStatus_Sel = DDO_Grid.SelectedValue_get
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	...
	WWPBaseObjects.SaveColumnsSelectorState(!'Embarques.OrdenesWWColumnsSelector', iif(&ColumnsSelectorXML.IsEmpty(), '', &ColumnsSelector.ToXml()))
	Refresh
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	Do Case
		...
		Case ddo_ManageFilters.ActiveEventKey = !'<#Save#>'
			Do 'SaveGridState'
			SaveFilterAs.Popup(!'Embarques.OrdenesWWFilters', &PgmName + !"GridState")
			&ManageFiltersExecutionStep = 2
			Refresh
		Case ddo_ManageFilters.ActiveEventKey = !'<#Manage#>'
			ManageFilters.Popup(!'Embarques.OrdenesWWFilters')
			&ManageFiltersExecutionStep = 2
			Refresh
		Otherwise
			&ManageFiltersXml = GetFilterByName(!'Embarques.OrdenesWWFilters', ddo_ManageFilters.ActiveEventKey)
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	If (&IsAuthorized_Insert)
		DB.Order.Call(TrnMode.Insert, nullvalue(OrderDoc), nullvalue(OrderNumPar), nullvalue(ProductNumber))
	Else
