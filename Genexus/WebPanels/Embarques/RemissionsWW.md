...
| CrearEmbarque | Variable | CHARACTER |  | Crear Embarque |
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	...
	If &Session.Get(!'Embarques.RemissionsWWColumnsSelector') <> ''
		&ColumnsSelectorXML = &Session.Get(!'Embarques.RemissionsWWColumnsSelector')
		&ColumnsSelector.FromXml(&ColumnsSelectorXML)
	Else
		Do 'InitializeColumnsSelector'
	EndIf
	RemissionDoc.Visible = &ColumnsSelector.Columns.Item(1).IsVisible
	OrderDoc.Visible = &ColumnsSelector.Columns.Item(2).IsVisible
	OrderNumPar.Visible = &ColumnsSelector.Columns.Item(3).IsVisible
	ProductNumber.Visible = &ColumnsSelector.Columns.Item(4).IsVisible
	OrderKey.Visible = &ColumnsSelector.Columns.Item(5).IsVisible
	...
	RemissionDate.Visible = &ColumnsSelector.Columns.Item(11).IsVisible
	RemissionQuantity.Visible = &ColumnsSelector.Columns.Item(12).IsVisible
	RemissionPXS.Visible = &ColumnsSelector.Columns.Item(13).IsVisible
	RemissionPrice.Visible = &ColumnsSelector.Columns.Item(14).IsVisible
	RemissionTotal.Visible = &ColumnsSelector.Columns.Item(15).IsVisible
	RemissionStatus.Visible = &ColumnsSelector.Columns.Item(16).IsVisible
	RemissionTotalPallets.Visible = &ColumnsSelector.Columns.Item(17).IsVisible
	FTBCustomer.Visible = &ColumnsSelector.Columns.Item(18).IsVisible
	RemissionEmbarqueGenerado.Visible = &ColumnsSelector.Columns.Item(19).IsVisible
	...
	Do Case
		...
		Case DDO_Grid.ActiveEventKey = !'<#Filter#>'
			Do Case
				...
				Case DDO_Grid.SelectedColumn = !'RemissionStatus'
					&TFRemissionStatus = DDO_Grid.FilteredText_get
					&TFRemissionStatus_Sel = DDO_Grid.SelectedValue_get
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	...
	If (&IsAuthorized_Delete)
		&Delete.Link = DB.Remission.Link(GeneXus.TrnMode.Delete, DB.RemissionDoc, WWPBaseObjects.OrderDoc, OrderNumPar, WWPBaseObjects.ProductNumber)
	Endif
	&CrearEmbarque = "Crear Embarque"
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	...
	SaveColumnsSelectorState(!'Embarques.RemissionsWWColumnsSelector', iif(&ColumnsSelectorXML.IsEmpty(), '', &ColumnsSelector.ToXml()))
	Refresh
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	Do Case
		...
		Case ddo_ManageFilters.ActiveEventKey = !'<#Save#>'
			Do 'SaveGridState'
			SaveFilterAs.Popup(!'Embarques.RemissionsWWFilters', &PgmName + !"GridState")
			&ManageFiltersExecutionStep = 2
			Refresh
		Case ddo_ManageFilters.ActiveEventKey = !'<#Manage#>'
			ManageFilters.Popup(!'Embarques.RemissionsWWFilters')
			&ManageFiltersExecutionStep = 2
			Refresh
		Otherwise
			&ManageFiltersXml = GetFilterByName(!'Embarques.RemissionsWWFilters', ddo_ManageFilters.ActiveEventKey)
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	If (&IsAuthorized_Insert)
		DB.Remission.Call(TrnMode.Insert, nullvalue(RemissionDoc), nullvalue(OrderDoc), nullvalue(OrderNumPar), nullvalue(ProductNumber))
	Else
...
```genexus
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	WWPAux_WC.Object = WWP_SubscriptionsPanel.Create(!'Remission', WWP_NotificationAppliesTo.AnyRecord, '', '')
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
