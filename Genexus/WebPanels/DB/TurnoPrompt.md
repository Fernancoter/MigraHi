# WebPanel: TurnoPrompt

- **Module:** DB
- **Description:** Select Turno
- **GAM Object:** No
...
| InOutTurnoId | Variable | NUMERIC |  | In Out Turno Id |
| InOutTurnoNombre | Variable | VARCHAR |  | In Out Turno Nombre |
...
```genexus
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	&InOutTurnoId = TurnoId
	&InOutTurnoNombre = TurnoNombre
	Return
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
...
parm(InOut:&InOutTurnoId, InOut:&InOutTurnoNombre);
