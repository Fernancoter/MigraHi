# WebPanel: TroquelPrompt

- **Module:** DB
- **Description:** Select Troquel
- **GAM Object:** No
...
| InOutTroquelId | Variable | NUMERIC |  | In Out Troquel Id |
| InOutTroquelNombre | Variable | VARCHAR |  | In Out Troquel Nombre |
...
```genexus
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	&InOutTroquelId = TroquelId
	&InOutTroquelNombre = TroquelNombre
	Return
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
...
parm(InOut:&InOutTroquelId, InOut:&InOutTroquelNombre);
