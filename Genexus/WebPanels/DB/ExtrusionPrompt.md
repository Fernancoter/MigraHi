# WebPanel: ExtrusionPrompt

- **Module:** DB
- **Description:** Select Extrusion
- **GAM Object:** No
...
| InOutExtrusionId | Variable | NUMERIC |  | In Out Extrusion Id |
...
| InOutExtrusionExtrusoraNombre | Variable | VARCHAR |  | In Out Extrusion Extrusora Nombre |
...
```genexus
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	&InOutExtrusionId = ExtrusionId
	&InOutExtrusionExtrusoraNombre = ExtrusionExtrusoraNombre
	Return
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
...
parm(InOut:&InOutExtrusionId, InOut:&InOutExtrusionExtrusoraNombre);
