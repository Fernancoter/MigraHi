# WebPanel: TroquelProductoPrompt

- **Module:** DB
- **Description:** Select Producto
- **GAM Object:** No
...
| InTroquelId | Variable | NUMERIC |  | In Troquel Id |
| InOutTroquelProductoId | Variable | NUMERIC |  | In Out Troquel Producto Id |
...
| InOutProductoId | Variable | NUMERIC |  | In Out Producto Id |
...
parm(In:&InTroquelId, InOut:&InOutProductoId);
