# WebPanel: CarretePrompt

- **Module:** DB
- **Description:** Select Carrete
- **GAM Object:** No
...
| InOutCarreteId | Variable | NUMERIC |  | In Out Carrete Id |
| InOutCarreteNoLinea | Variable | NUMERIC |  | In Out Carrete No Linea |
...
```genexus
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	&InOutCarreteId = CarreteId
	&InOutCarreteNoLinea = CarreteNoLinea
	Return
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
...
parm(InOut:&InOutCarreteId, InOut:&InOutCarreteNoLinea);
