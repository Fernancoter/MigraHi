...
| InCustomer | Variable | VARCHAR |  | In Customer |
| InOutProductNumber | Variable | VARCHAR |  | In Out Product Number |
| InOutBudgetYear | Variable | NUMERIC |  | In Out Budget Year |
| InOutBudgetMonth | Variable | NUMERIC |  | In Out Budget Month |
| InOutBudgetReal | Variable | NUMERIC |  | In Out Budget Real |
...
```genexus
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	&InOutProductNumber = ProductNumber
	&InOutBudgetYear = BudgetYear
	&InOutBudgetMonth = BudgetMonth
	&InOutBudgetReal = BudgetReal
	Return
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
...
parm(In:&InCustomer, InOut:&InOutProductNumber, InOut:&InOutBudgetYear, InOut:&InOutBudgetMonth, InOut:&InOutBudgetReal);
