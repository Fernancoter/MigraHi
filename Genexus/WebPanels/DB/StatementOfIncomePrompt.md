# WebPanel: StatementOfIncomePrompt

- **Module:** DB
- **Description:** Select Statement Of Income
- **GAM Object:** No
...
| InOutStatementOfIncomeCuenta | Variable | VARCHAR |  | In Out Statement Of Income Cuenta |
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	...
	Form.Caption = 'Select Statement Of Income'
	If &OrderedBy < 1
		&OrderedBy = 1
...
```genexus
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	&InOutStatementOfIncomeCuenta = StatementOfIncomeCuenta
	Return
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
...
parm(InOut:&InOutStatementOfIncomeCuenta);
