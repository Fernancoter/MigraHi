...
| InOutCompanyName | Variable | VARCHAR |  | In Out Company Name |
...
| InOutCompanyId | Variable | NUMERIC |  | In Out Company Id |
...
```genexus
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	&InOutCompanyId = CompanyId
	&InOutCompanyName = CompanyName
	Return
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
...
parm(InOut:&InOutCompanyId, InOut:&InOutCompanyName);
