...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	...
	TroquelEstado.Visible = &ColumnsSelector.Columns.Item(3).IsVisible
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	...
	If (&IsAuthorized_Display)
		&Display.Link = TroquelView.Link(TroquelId, &TabCode)
	Endif
	&Update = "GXM_update"
	If (&IsAuthorized_Update)
		&Update.Link = gestionarTroquel.Link(TrnMode.Update, TroquelId)
	Endif
	&Delete = "GX_BtnDelete"
	...
	If (&IsAuthorized_TroquelNombre)
		TroquelNombre.Link = DB.TroquelView.Link(TroquelId, '')
	Endif
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	Do Case
		...
		Case ddo_ManageFilters.ActiveEventKey = !'<#Save#>'
			Do 'SaveGridState'
			SaveFilterAs.Popup(!'Produccion.listarTroquelFilters', &PgmName + !"GridState")
			&ManageFiltersExecutionStep = 2
			Refresh
