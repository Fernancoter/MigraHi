...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	...
	PrensaImagen.Visible = &ColumnsSelector.Columns.Item(2).IsVisible
	PrensaMarca.Visible = &ColumnsSelector.Columns.Item(3).IsVisible
	PrensaModelo.Visible = &ColumnsSelector.Columns.Item(4).IsVisible
	...
	Do Case
		...
		Case DDO_Grid.ActiveEventKey = !'<#Filter#>'
			Do Case
				...
				Case DDO_Grid.SelectedColumn = !'PrensaMarca'
					&TFPrensaMarca = DDO_Grid.FilteredText_get
					&TFPrensaMarca_Sel = DDO_Grid.SelectedValue_get
				Case DDO_Grid.SelectedColumn = !'PrensaModelo'
					&TFPrensaModelo = DDO_Grid.FilteredText_get
					&TFPrensaModelo_Sel = DDO_Grid.SelectedValue_get
			EndCase
			Grid.FirstPage()
	EndCase
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	...
	If (&IsAuthorized_Display)
		&Display.Link = gestionarPrensa.Link(TrnMode.Display, PrensaId)
	Endif
	&Update = "GXM_update"
	If (&IsAuthorized_Update)
		&Update.Link = gestionarPrensa.Link(TrnMode.Update, PrensaId)
	Endif
	&Delete = "GX_BtnDelete"
	If (&IsAuthorized_Delete)
		&Delete.Link = gestionarPrensa.Link(TrnMode.Delete, PrensaId)
	Endif
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	...
	SaveColumnsSelectorState(!'Produccion.listarPrensasColumnsSelector', iif(&ColumnsSelectorXML.IsEmpty(), '', &ColumnsSelector.ToXml()))
	Refresh
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	Do Case
		...
		Case ddo_ManageFilters.ActiveEventKey = !'<#Save#>'
			Do 'SaveGridState'
			SaveFilterAs.Popup(!'Produccion.listarPrensasFilters', &PgmName + !"GridState")
			&ManageFiltersExecutionStep = 2
			Refresh
		Case ddo_ManageFilters.ActiveEventKey = !'<#Manage#>'
			ManageFilters.Popup(!'Produccion.listarPrensasFilters')
			&ManageFiltersExecutionStep = 2
			Refresh
		Otherwise
			&ManageFiltersXml = GetFilterByName(!'Produccion.listarPrensasFilters', ddo_ManageFilters.ActiveEventKey)
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	If (&IsAuthorized_cmdAgregar)
		gestionarPrensa.Call(TrnMode.Insert, &PrensaId)
	Else
