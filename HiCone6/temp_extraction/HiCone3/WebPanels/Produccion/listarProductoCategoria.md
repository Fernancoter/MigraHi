# WebPanel: listarProductoCategoria
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	...
	Form.Caption = ' Producto Categoria'
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	...
	If (&IsAuthorized_Display)
		&Display.Link = gestionarProductoCategoria.Link(TrnMode.Display, ProductoCategoriaId)
	Endif
	&Update = "GXM_update"
	If (&IsAuthorized_Update)
		&Update.Link = gestionarProductoCategoria.Link(TrnMode.Update, ProductoCategoriaId)
	Endif
	&Delete = "GX_BtnDelete"
	If (&IsAuthorized_Delete)
		&Delete.Link = gestionarProductoCategoria.Link(TrnMode.Delete, ProductoCategoriaId)
	Endif
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	...
	SaveColumnsSelectorState(!'Produccion.listarProductoCategoriaColumnsSelector', iif(&ColumnsSelectorXML.IsEmpty(), '', &ColumnsSelector.ToXml()))
	Refresh
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	Do Case
		...
		Case ddo_ManageFilters.ActiveEventKey = !'<#Save#>'
			Do 'SaveGridState'
			SaveFilterAs.Popup(!'Produccion.listarProductoCategoriaFilters', &PgmName + !"GridState")
			&ManageFiltersExecutionStep = 2
			Refresh
		Case ddo_ManageFilters.ActiveEventKey = !'<#Manage#>'
			ManageFilters.Popup(!'Produccion.listarProductoCategoriaFilters')
			&ManageFiltersExecutionStep = 2
			Refresh
		Otherwise
			&ManageFiltersXml = GetFilterByName(!'Produccion.listarProductoCategoriaFilters', ddo_ManageFilters.ActiveEventKey)
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	If (&IsAuthorized_cmdAgregar)
		gestionarProductoCategoria.Call(TrnMode.Insert, &ProductoCategoriaId)
	Else
