# WebPanel: CausaInterrupcionPrompt

- **Module:** Reportes
- **Description:** Select Causa Interrupcion
- **GAM Object:** No
...
| InOutCausaInterrupcionId | Variable | NUMERIC |  | In Out Causa Interrupcion Id |
| InOutCausaInterrupcionNombre | Variable | VARCHAR |  | In Out Causa Interrupcion Nombre |
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	...
	Form.Caption = 'Select Causa Interrupcion'
	If &OrderedBy < 1
		&OrderedBy = 1
...
```genexus
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	&InOutCausaInterrupcionId = CausaInterrupcionId
	&InOutCausaInterrupcionNombre = CausaInterrupcionNombre
	Return
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
...
parm(InOut:&InOutCausaInterrupcionId, InOut:&InOutCausaInterrupcionNombre);
