# WebPanel: PrensaObservacionCausaInterrupcionPrompt
...
| InPrensaObservacionId | Variable | NUMERIC |  | In Prensa Observacion Id |
...
parm(In:&InPrensaObservacionId, InOut:&InOutCausaInterrupcionId);
