# WebPanel: WWP_MailTemplatePrompt

- **Module:** WWPBaseObjects.Mail
- **Description:** Select Mail Template
- **GAM Object:** No
...
| InOutWWPMailTemplateName | Variable | VARCHAR |  | In Out WWPMail Template Name |
| InOutWWPMailTemplateDescription | Variable | VARCHAR |  | In Out WWPMail Template Description |
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	...
	Form.Caption = 'Select Mail Template'
	If &OrderedBy < 1
		&OrderedBy = 1
...
```genexus
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	&InOutWWPMailTemplateName = WWPMailTemplateName
	&InOutWWPMailTemplateDescription = WWPMailTemplateDescription
	Return
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
...
parm(InOut:&InOutWWPMailTemplateName, InOut:&InOutWWPMailTemplateDescription);
