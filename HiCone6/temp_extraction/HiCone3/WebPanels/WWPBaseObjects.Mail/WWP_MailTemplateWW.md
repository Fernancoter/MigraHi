...
| IsAuthorized_WWPMailTemplateDescription | Variable | Boolean |  | Is Authorized_WWPMail Template Description |
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	...
	&IsAuthorized_WWPMailTemplateDescription = SecGAMIsAuthByFunctionalityKey.Udp(!'wwp_mailtemplateview_Execute')
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	...
	If (&IsAuthorized_Delete)
		&Delete.Link = WWPBaseObjects.Mail.WWP_MailTemplate.Link(TrnMode.Delete, WWPMailTemplateName)
	Endif
	If (&IsAuthorized_WWPMailTemplateDescription)
		WWPMailTemplateDescription.Link = WWPBaseObjects.Mail.WWP_MailTemplateView.Link(WWPMailTemplateName, '')
	Endif
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	Do Case
		...
		Case ddo_ManageFilters.ActiveEventKey = !'<#Save#>'
			Do 'SaveGridState'
			SaveFilterAs.Popup(!'WWPBaseObjects.Mail.WWP_MailTemplateWWFilters', &PgmName + !"GridState")
			&ManageFiltersExecutionStep = 2
			Refresh
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	If (&IsAuthorized_Insert)
		WWPBaseObjects.Mail.WWP_MailTemplate.Call(TrnMode.Insert, nullvalue(WWPMailTemplateName))
	Else
...
```genexus
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	WWPAux_WC.Object = WWP_SubscriptionsPanel.Create(!'WWP_MailTemplate', WWPBaseObjects.Notifications.WWP_NotificationAppliesTo.AnyRecord, '', '')
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
