# WebPanel: PrensaPrompt

- **Module:** DB
- **Description:** Select Prensa
- **GAM Object:** No
...
| InOutPrensaId | Variable | NUMERIC |  | In Out Prensa Id |
| InOutPrensaNombre | Variable | VARCHAR |  | In Out Prensa Nombre |
...
```genexus
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	&InOutPrensaId = PrensaId
	&InOutPrensaNombre = PrensaNombre
	Return
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
...
parm(InOut:&InOutPrensaId, InOut:&InOutPrensaNombre);
