# WebPanel: PrensadoPrompt

- **Module:** DB
- **Description:** Select Prensado
- **GAM Object:** No
...
| InOutPrensadoId | Variable | NUMERIC |  | In Out Prensado Id |
| InOutPrensadoFecha | Variable | DATETIME |  | In Out Prensado Fecha |
...
```genexus
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	&InOutPrensadoId = PrensadoId
	&InOutPrensadoFecha = PrensadoFecha
	Return
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
...
parm(InOut:&InOutPrensadoId, InOut:&InOutPrensadoFecha);
