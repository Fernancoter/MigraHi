# WebPanel: ExistenciaPrompt

- **Module:** DB
- **Description:** Select Existencia
- **GAM Object:** No
...
| InOutExistenciaId | Variable | NUMERIC |  | In Out Existencia Id |
| InOutExistenciaNo | Variable | VARCHAR |  | In Out Existencia No |
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	...
	Form.Caption = 'Select Existencia'
	If &OrderedBy < 1
		&OrderedBy = 1
...
```genexus
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	&InOutExistenciaId = ExistenciaId
	&InOutExistenciaNo = ExistenciaNo
	Return
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
...
parm(InOut:&InOutExistenciaId, InOut:&InOutExistenciaNo);
