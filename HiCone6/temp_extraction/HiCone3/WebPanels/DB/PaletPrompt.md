# WebPanel: PaletPrompt

- **Module:** DB
- **Description:** Select Palet
- **GAM Object:** No
...
| InOutPaletId | Variable | NUMERIC |  | In Out Palet Id |
| InOutPaletNoSerie | Variable | VARCHAR |  | In Out Palet No Serie |
...
```genexus
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	&InOutPaletId = PaletId
	&InOutPaletNoSerie = PaletNoSerie
	Return
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
...
parm(InOut:&InOutPaletId, InOut:&InOutPaletNoSerie);
