...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	...
	If (&IsAuthorized_Update)
		&Update.Link = DB.Consolidated.Link(TrnMode.Update, ConsolidatedName)
	Endif
	&Delete = !'<i class="fa fa-times"></i>'
	If (&IsAuthorized_Delete)
		&Delete.Link = DB.Consolidated.Link(TrnMode.Delete, ConsolidatedName)
	Endif
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	Do Case
		...
		Case ddo_ManageFilters.ActiveEventKey = !'<#Manage#>'
			...
			Refresh
		Otherwise
			&ManageFiltersXml = GetFilterByName(!'DB.ConsolidatedWWFilters', ddo_ManageFilters.ActiveEventKey)
