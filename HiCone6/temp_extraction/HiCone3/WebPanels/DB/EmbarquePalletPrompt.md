# WebPanel: EmbarquePalletPrompt

- **Module:** DB
- **Description:** Select Embarque Pallet
- **GAM Object:** No
...
| InEmbarqueId | Variable | NUMERIC |  | In Embarque Id |
| InEmbarqueDetalleId | Variable | NUMERIC |  | In Embarque Detalle Id |
| InOutEmbarquePalletNoPallet | Variable | VARCHAR |  | In Out Embarque Pallet No Pallet |
...
| InOutEmbarquePalletValido | Variable | Boolean |  | In Out Embarque Pallet Valido |
...
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	...
	Form.Caption = 'Select Embarque Pallet'
	EmbarquePalletValido.Visible = False
	If &OrderedBy < 1
		&OrderedBy = 1
...
```genexus
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	&InOutEmbarquePalletNoPallet = EmbarquePalletNoPallet
	&InOutEmbarquePalletValido = EmbarquePalletValido
	Return
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
...
parm(In:&InEmbarqueDetalleId, InOut:&InOutEmbarquePalletNoPallet, InOut:&InOutEmbarquePalletValido);
