# WebPanel: CarreraPrompt

- **Module:** DB
- **Description:** Select Carrera
- **GAM Object:** No
...
| InOutCarreraId | Variable | NUMERIC |  | In Out Carrera Id |
| InOutCarreraNo | Variable | NUMERIC |  | In Out Carrera No |
...
```genexus
/* Generated by DVelop Work With Plus Pattern [Start] - Do not change */
	&InOutCarreraId = CarreraId
	&InOutCarreraNo = CarreraNo
	Return
	/* Generated by DVelop Work With Plus Pattern [End] - Do not change */
```
...
parm(InOut:&InOutCarreraId, InOut:&InOutCarreraNo);
