# Procedure: PalletCarreteReportMainPCR

- **Module:** PrinterSD
- **Description:** Pallet Carrete Report Main PCR
- **GAM Object:** No
...
Web.Debugger.Call(NivelDebug.Informativo, &Pgmname, &EtiquetaCarretaSDT.ToJson())
