...
Sub 'PrintData'
	...
	For each DB.EmbarquePallet
		...
		order WWPBaseObjects.DB.EmbarqueClienteEnvia  when &OrderedBy = 5 AND &OrderedDsc = False
		...
		order Mail.EmbarquePalletNoPallet  when &OrderedBy = 7 AND &OrderedDsc = False
