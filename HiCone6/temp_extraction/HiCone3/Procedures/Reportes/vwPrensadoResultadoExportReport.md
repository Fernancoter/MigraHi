...
&IsAuthorized = WWPBaseObjects.SecGAMIsAuthByFunctionalityKey.Udp(!'vwprensadoresultado_Execute') 
If &IsAuthorized
...
Sub 'PrintData'
	...
	For each DB.PrensadoResultado
		...
		order DB.PrensadoResultadoHerramientas  when &OrderedBy = 10 AND &OrderedDsc = False
		...
		order DB.PrensadoFecha  when &OrderedBy = 21 AND &OrderedDsc = False
