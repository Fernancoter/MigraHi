...
Sub 'WriteFilters'
	...
	Else
		If not (&TFOperadorEtiquetadoNombre.IsEmpty())
			WWP_ExportWriteFilter(&ExcelDocument, true, &CellRow, &FirstColumn, "Operador")
			&ExcelDocument.Cells(&CellRow, &FirstColumn + 1).Text = WWPBaseObjects.WWP_Export_SecureText(&TFOperadorEtiquetadoNombre)
		EndIf
	EndIf
	...
	Else
		If not (&TFTurnoEtiquetadoNombre.IsEmpty())
			WWP_ExportWriteFilter(&ExcelDocument, true, &CellRow, &FirstColumn, "Turno")
			&ExcelDocument.Cells(&CellRow, &FirstColumn + 1).Text = WWPBaseObjects.WWP_Export_SecureText(&TFTurnoEtiquetadoNombre)
		EndIf
	EndIf
	If not (&TFOrdenEtiquetadoPiezasBuenas.IsEmpty() AND &TFOrdenEtiquetadoPiezasBuenas_To.IsEmpty())
		WWPBaseObjects.WWP_ExportWriteFilter(&ExcelDocument, true, &CellRow, &FirstColumn, "Piezas Buenas")
	...
	Else
		If not (&TFOrdenEtiquetadoEtiquetadoraActiva.IsEmpty())
			WWPBaseObjects.WWP_ExportWriteFilter(&ExcelDocument, true, &CellRow, &FirstColumn, "Etiquetadora Activa")
	...
	Else
		If not (&TFOrdenEtiquetadoObservaciones.IsEmpty())
			WWP_ExportWriteFilter(&ExcelDocument, true, &CellRow, &FirstColumn, "Observaciones")
			&ExcelDocument.Cells(&CellRow, &FirstColumn + 1).Text = WWPBaseObjects.WWP_Export_SecureText(&TFOrdenEtiquetadoObservaciones)
		EndIf
	EndIf
...
Sub 'WriteData'
	...
	For each DB.OrdenEtiquetado
		...
		order Web.OrdenEtiquetadoPiezasBuenas  when &OrderedBy = 5 AND &OrderedDsc = False
			...
			If &ColumnsSelector_Column.IsVisible = True
				Do Case
					...
					Case &ColumnsSelector_Column.ColumnName = !'OrdenEtiquetadoEtiquetadoraActiva'
						&ExcelDocument.Cells(&CellRow, &FirstColumn + &VisibleColumnCount).Text = WWP_Export_SecureText(DB.OrdenEtiquetadoEtiquetadoraActiva)
					Case &ColumnsSelector_Column.ColumnName = !'OrdenEtiquetadoVelLineaUno'
						&ExcelDocument.Cells(&CellRow, &FirstColumn + &VisibleColumnCount).Text = WWP_Export_SecureText(Notifications.OrdenEtiquetadoVelLineaUno)
					Case &ColumnsSelector_Column.ColumnName = !'OrdenEtiquetadoVelLineaDos'
						&ExcelDocument.Cells(&CellRow, &FirstColumn + &VisibleColumnCount).Text = WWP_Export_SecureText(OrdenEtiquetadoVelLineaDos)
					...
					Case &ColumnsSelector_Column.ColumnName = !'OrdenEtiquetadoObservaciones'
						&ExcelDocument.Cells(&CellRow, &FirstColumn + &VisibleColumnCount).Text = WWP_Export_SecureText(OrdenEtiquetadoObservaciones)
				EndCase
				&VisibleColumnCount += 1
			EndIf
		EndFor		
...
Sub 'InitializeColumnsSelector'
	...
	WWP_ColumnsSelector_Add(&ColumnsSelector, !"OrdenEtiquetadoFechaInicio", '', !'Fecha Inicio', False, '')
	WWP_ColumnsSelector_Add(&ColumnsSelector, !"OrdenEtiquetadoFechaTermina", '', !'Fecha Termina', False, '')
	WWP_ColumnsSelector_Add(&ColumnsSelector, !"OperadorEtiquetadoNombre", '', !'Operador', True, '')
	...
	WWP_ColumnsSelector_Add(&ColumnsSelector, !"OrdenEtiquetadoPiezasMolino", '', !'Piezas Molino', True, '')
