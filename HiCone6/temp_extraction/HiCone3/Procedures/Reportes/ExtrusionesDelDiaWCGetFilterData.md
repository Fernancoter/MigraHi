# Procedure: ExtrusionesDelDiaWCGetFilterData

- **Module:** Reportes
- **Description:** Extrusiones Del Dia WCGet Filter Data
- **GAM Object:** No
...
Sub 'LoadGridState'
	...
	If &Session.Get(!"Reportes.ExtrusionesDelDiaWCGridState") = !""
		&GridState.FromXml(LoadGridState.Udp(!"Reportes.ExtrusionesDelDiaWCGridState"))
	Else
		&GridState.FromXml(&Session.Get(!"Reportes.ExtrusionesDelDiaWCGridState"))
	Endif	
...
Sub 'LoadExtrusionExtrusoraNombreOptions'
	...
	For Each DB.Extrusion
		...
		using ExtrusionesDelDiaWCDS(&TFExtrusionExtrusoraNombre, &TFExtrusionExtrusoraNombre_Sel, &TFExtrusionTurnoNombre, &TFExtrusionTurnoNombre_Sel, &TFExtrusionProductoNombre, &TFExtrusionProductoNombre_Sel
					, &TFExtrusionOperadorNombre, &TFExtrusionOperadorNombre_Sel, &TFExtrusionMeta, &TFExtrusionMeta_To)
		Where ExtrusionFecha.ToDate() = JornadaLaboral.Udp()
