...
Sub 'WriteFilters'
	...
	If not (&TFExtrusionInterrupcionId.IsEmpty() AND &TFExtrusionInterrupcionId_To.IsEmpty())
		WWPBaseObjects.WWP_ExportWriteFilter(&ExcelDocument, true, &CellRow, &FirstColumn, "Interrupcion Id")
...
Sub 'InitializeColumnsSelector'
	...
	&UserCustomValue = WWPBaseObjects.LoadColumnsSelectorState.Udp(!'DB.ExtrusionInterrupcionWWColumnsSelector')
...
Sub 'LoadGridState'
	...
	If &Session.Get(!"DB.ExtrusionInterrupcionWWGridState") = !""
		&GridState.FromXml(WWPBaseObjects.LoadGridState.Udp(!"DB.ExtrusionInterrupcionWWGridState"))
	Else
