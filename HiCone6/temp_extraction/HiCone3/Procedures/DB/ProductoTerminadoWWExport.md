...
Sub 'WriteFilters'
	...
	If not (&TFProductoTerminadoPeso.IsEmpty() AND &TFProductoTerminadoPeso_To.IsEmpty())
		WWPBaseObjects.WWP_ExportWriteFilter(&ExcelDocument, true, &CellRow, &FirstColumn, "Terminado Peso")
...
Sub 'WriteData'
	...
	For each ProductoTerminado
		...
		order (Produccion.ProductoTerminadoCarreteMillar)  when &OrderedBy = 2 AND &OrderedDsc = True
			...
			If &ColumnsSelector_Column.IsVisible = True
				Do Case
					...
					Case &ColumnsSelector_Column.ColumnName = !'TerminadoProductoNombre'
						&ExcelDocument.Cells(&CellRow, &FirstColumn + &VisibleColumnCount).Text = WWP_Export_SecureText(Produccion.TerminadoProductoNombre)
				EndCase
				&VisibleColumnCount += 1
			EndIf
		EndFor		
...
Sub 'InitializeColumnsSelector'
	...
	WWPBaseObjects.WWP_ColumnsSelector_Add(&ColumnsSelector, !"ProductoTerminadoPaletMillar", '', !'Palet Millar', True, '')
	WWPBaseObjects.WWP_ColumnsSelector_Add(&ColumnsSelector, !"ProductoTerminadoPeso", '', !'Terminado Peso', True, '')
