...
Sub 'WriteFilters'
	...
	If not (&TFExistenciaTurnoNombre_Sel.IsEmpty())
		...
		&ExcelDocument.Cells(&CellRow, &FirstColumn + 1).Text = WWPBaseObjects.WWP_Export_SecureText(&TFExistenciaTurnoNombre_Sel)
	Else
...
Sub 'InitializeColumnsSelector'
	...
	&UserCustomValue = LoadColumnsSelectorState.Udp(!'DB.ExistenciaWWColumnsSelector')
