# Procedure: ProductoTerminadoWWGetFilterData

- **Module:** DB
- **Description:** Producto Terminado WWGet Filter Data
- **GAM Object:** No
...
Sub 'LoadTerminadoProductoNombreOptions'
	...
	For Each ProductoTerminado
		...
		using DB.ProductoTerminadoWWDS(&FilterFullText, &TFProductoTerminadoPalets, &TFProductoTerminadoPalets_To, &TFProductoTerminadoCarreteMillar, &TFProductoTerminadoCarreteMillar_To, &TFProductoTerminadoPaletMillar
