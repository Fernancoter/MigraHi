...
for &DynamicFormField in &DynamicFormFields
	...
	if &DynamicFormField.MDFDynamicFieldType = SDPMDFFieldType.Numeric
		&FormFieldsJson += &DynamicFormField.MDFDynamicFieldValueNumeric.ToString()
	endif
	if &DynamicFormField.MDFDynamicFieldType = WorkWithPlus.NativeMobile.SDPMDFFieldType.Decimal
