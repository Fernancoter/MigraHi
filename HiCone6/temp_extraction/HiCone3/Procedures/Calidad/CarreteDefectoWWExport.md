...
Sub 'WriteFilters'
	...
	If not (&TFCarreteDefectoId.IsEmpty() AND &TFCarreteDefectoId_To.IsEmpty())
		WWP_ExportWriteFilter(&ExcelDocument, true, &CellRow, &FirstColumn, "")
	...
	If not (&TFCarreteDefectoNombre_Sel.IsEmpty())
		...
		&ExcelDocument.Cells(&CellRow, &FirstColumn + 1).Text = WWPBaseObjects.WWP_Export_SecureText(&TFCarreteDefectoNombre_Sel)
	Else
		If not (&TFCarreteDefectoNombre.IsEmpty())
			WWP_ExportWriteFilter(&ExcelDocument, true, &CellRow, &FirstColumn, "Nombre")
			&ExcelDocument.Cells(&CellRow, &FirstColumn + 1).Text = WWP_Export_SecureText(&TFCarreteDefectoNombre)
		EndIf
	EndIf
	&CellRow += 2
