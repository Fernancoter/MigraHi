# Procedure: TableroDirectivoPrensadoGetFilterData

- **Module:** Produccion
- **Description:** Tablero Directivo Prensado Get Filter Data
- **GAM Object:** No
...
Sub 'LoadGridState'
	...
	If &Session.Get(!"Produccion.TableroDirectivoPrensadoGridState") = !""
		&GridState.FromXml(LoadGridState.Udp(!"Produccion.TableroDirectivoPrensadoGridState"))
	Else
		&GridState.FromXml(&Session.Get(!"Produccion.TableroDirectivoPrensadoGridState"))
	Endif	
...
Sub 'LoadPrensadoPrensaNombreOptions'
	...
	For Each DB.Prensado
		...
		using TableroDirectivoPrensadoDS(&TFPrensadoFecha, &TFPrensadoFecha_To, &TFPrensadoPrensaNombre, &TFPrensadoPrensaNombre_Sel, &TFPrensadoTurnoNombre, &TFPrensadoTurnoNombre_Sel
					, &TFPrensadoProductoNombre, &TFPrensadoProductoNombre_Sel, &TFPrensadoOperadorNombre, &TFPrensadoOperadorNombre_Sel, &TFPrensadoMeta, &TFPrensadoMeta_To
					, &TFPrensadoTotalPalets, &TFPrensadoTotalPalets_To)
...
Sub 'LoadPrensadoTurnoNombreOptions'
	...
	For Each DB.Prensado
		...
		using TableroDirectivoPrensadoDS(&TFPrensadoFecha, &TFPrensadoFecha_To, &TFPrensadoPrensaNombre, &TFPrensadoPrensaNombre_Sel, &TFPrensadoTurnoNombre, &TFPrensadoTurnoNombre_Sel
					, &TFPrensadoProductoNombre, &TFPrensadoProductoNombre_Sel, &TFPrensadoOperadorNombre, &TFPrensadoOperadorNombre_Sel, &TFPrensadoMeta, &TFPrensadoMeta_To
					, &TFPrensadoTotalPalets, &TFPrensadoTotalPalets_To)
		Where PrensadoEstado in (Produccion.EstadoPrensado.Programado, EstadoPrensado.Terminado)
...
Sub 'LoadPrensadoProductoNombreOptions'
	...
	For Each DB.Prensado
		...
		using TableroDirectivoPrensadoDS(&TFPrensadoFecha, &TFPrensadoFecha_To, &TFPrensadoPrensaNombre, &TFPrensadoPrensaNombre_Sel, &TFPrensadoTurnoNombre, &TFPrensadoTurnoNombre_Sel
					, &TFPrensadoProductoNombre, &TFPrensadoProductoNombre_Sel, &TFPrensadoOperadorNombre, &TFPrensadoOperadorNombre_Sel, &TFPrensadoMeta, &TFPrensadoMeta_To
					, &TFPrensadoTotalPalets, &TFPrensadoTotalPalets_To)
		Where PrensadoEstado in (EstadoPrensado.Programado, Produccion.EstadoPrensado.Terminado)
