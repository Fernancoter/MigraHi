# Procedure: ListadoRemisionesGetFilterData

- **Module:** Embarques
- **Description:** Listado Remisiones Get Filter Data
- **GAM Object:** No
...
Sub 'LoadProductNumberOptions'
	...
	For Each DB.Remission
		Order WorkWithPlus.ProductNumber
		using ListadoRemisionesDS(&FilterFullText, &TFRemissionDate, &TFRemissionDate_To, &TFRemissionEmbarqueGenerado_Sel, &TFRemissionDoc, &TFRemissionDoc_Sel
					, &TFOrderDoc, &TFOrderDoc_Sel, &TFOrderNumPar, &TFOrderNumPar_To, &TFProductNumber, &TFProductNumber_Sel
					, &TFRemissionQuantity, &TFRemissionQuantity_To, &TFRemissionTotalPallets, &TFRemissionTotalPallets_To, &TFProductType, &TFProductType_Sel
					, &TFProductDesc, &TFProductDesc_Sel, &TFCustomer, &TFCustomer_Sel, &TFCustomerName, &TFCustomerName_Sel
...
Sub 'LoadProductTypeOptions'
	...
	For Each DB.Remission
		Order Notifications.ProductType
		using ListadoRemisionesDS(&FilterFullText, &TFRemissionDate, &TFRemissionDate_To, &TFRemissionEmbarqueGenerado_Sel, &TFRemissionDoc, &TFRemissionDoc_Sel
					, &TFOrderDoc, &TFOrderDoc_Sel, &TFOrderNumPar, &TFOrderNumPar_To, &TFProductNumber, &TFProductNumber_Sel
					, &TFRemissionQuantity, &TFRemissionQuantity_To, &TFRemissionTotalPallets, &TFRemissionTotalPallets_To, &TFProductType, &TFProductType_Sel
					, &TFProductDesc, &TFProductDesc_Sel, &TFCustomer, &TFCustomer_Sel, &TFCustomerName, &TFCustomerName_Sel
...
Sub 'LoadProductDescOptions'
	...
	For Each DB.Remission
		...
		For Each DB.Remission
			...
			&count += 1
		EndFor
		If not WWPBaseObjects.ProductDesc.IsEmpty()
			&Option = ProductDesc
...
Sub 'LoadFTBCustomerOptions'
	...
	For Each DB.Remission
		...
		For Each DB.Remission
			...
			&count += 1
		EndFor
		If not Produccion.FTBCustomer.IsEmpty()
			&Option = FTBCustomer
