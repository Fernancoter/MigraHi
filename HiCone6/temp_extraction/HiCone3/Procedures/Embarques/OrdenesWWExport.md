...
Sub 'WriteFilters'
	...
	If not (&TFOrderTotal.IsEmpty() AND &TFOrderTotal_To.IsEmpty())
		WWPBaseObjects.WWP_ExportWriteFilter(&ExcelDocument, true, &CellRow, &FirstColumn, "Total")
...
Sub 'WriteData'
	...
	For each DB.Order
		...
		order (DB.OrderKey)  when &OrderedBy = 10 AND &OrderedDsc = True
			...
			If &ColumnsSelector_Column.IsVisible = True
				Do Case
					...
					Case &ColumnsSelector_Column.ColumnName = !'ProductNumber'
						&ExcelDocument.Cells(&CellRow, &FirstColumn + &VisibleColumnCount).Text = WWP_Export_SecureText(DB.ProductNumber)
...
Sub 'InitializeColumnsSelector'
	...
	WWPBaseObjects.WWP_ColumnsSelector_Add(&ColumnsSelector, !"Customer", '', !'Código Cliente', False, '')
	...
	WWP_ColumnsSelector_Add(&ColumnsSelector, !"OrderPXS", '', !'Millares por Entregar', False, '')
