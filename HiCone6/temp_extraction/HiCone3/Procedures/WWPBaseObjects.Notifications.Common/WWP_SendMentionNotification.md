...
For Each WWP_NotificationDefinition
	...
	&WWPNotificationDefinitionId = DB.WWPNotificationDefinitionId
	...
	For &WWPUserExtendedId In &MentionsWWPUserExtendedIdCollection
		Common.WWP_CreateNotificationToUser(&WWPUserExtendedId, &WWPNotificationDefinitionId, &WWPNotificationDefinitionTitle, &WWPNotificationDefinitionShortDescription, &WWPNotificationDefinitionLongDescription, &WWPNotificationDefinitionLink, &WWPNotificationMetadata, &WWPNotificationDefinitionIcon, True)
	EndFor
