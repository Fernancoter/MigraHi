    ...
    <aside class="sidebar-dynamic shadow-right" [class.mini-mode]="!(isSidebarVisible$ | async)">
      ...
      <nav class="sidebar-nav">
        ...
        <ng-container *ngIf="(activeModule$ | async) === 'INVENTARIO'">
          ...
          <a routerLink="/produccion/catalogos/silos" routerLinkActive="active" class="nav-item" title="Silos">
        ...
        <!-- ── PRODUCCIÓN (Configurar Producción) ─────────────────────── -->
        <ng-container *ngIf="(activeModule$ | async) === 'PRODUCCIÓN'">
          <!-- Inicio -->
          <a routerLink="/produccion/inicio" routerLinkActive="active" [routerLinkActiveOptions]="{exact:true}" class="nav-item" title="Inicio">
            <div class="item-icon"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg></div>
            <span class="item-label">Inicio</span>
          </a>
          <!-- Operadores -->
          <a routerLink="/produccion/operarios" routerLinkActive="active" class="nav-item" title="Operadores">
          ...
          <!-- Productos -->
          <a routerLink="/produccion/productos" routerLinkActive="active" class="nav-item" title="Productos">
          ...
          <!-- Turnos por Semana -->
          <a routerLink="/produccion/turnos-semana" routerLinkActive="active" class="nav-item" title="Turnos Por Semana">
            <div class="item-icon"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/></svg></div>
            <span class="item-label">Turnos Por Semana</span>
          </a>
          ...
          <div class="collapsible-group">
            ...
            <div class="group-items animate-dropdown" *ngIf="catalogosExpanded">
              <a routerLink="/produccion/catalogos/categorias" routerLinkActive="active" class="nav-subitem" title="Categorías">
              ...
              <a routerLink="/produccion/catalogos/turnos" routerLinkActive="active" class="nav-subitem" title="Turnos">
              ...
              <a routerLink="/produccion/catalogos/extrusoras" routerLinkActive="active" class="nav-subitem" title="Extrusoras">
              ...
              <a routerLink="/produccion/catalogos/prensas" routerLinkActive="active" class="nav-subitem" title="Prensas">
              ...
              <a routerLink="/produccion/catalogos/silos" routerLinkActive="active" class="nav-subitem" title="Silos">
          ...
          <div class="collapsible-group">
            ...
            <div class="group-items animate-dropdown" *ngIf="referenciasExpanded">
              <a routerLink="/produccion/referencias/configuracion" routerLinkActive="active" class="nav-subitem" title="Configuración">
              ...
              <a routerLink="/produccion/referencias/extrusora-producto" routerLinkActive="active" class="nav-subitem" title="Extrusora Producto">
                <div class="subitem-icon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg></div>
                <span class="item-label">Extrusora Producto</span>
              </a>
              <a routerLink="/produccion/referencias/extrusora-mezcladora" routerLinkActive="active" class="nav-subitem" title="Extrusora Mezcladora">
                <div class="subitem-icon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg></div>
                <span class="item-label">Extrusora Mezcladora</span>
              </a>
              <a routerLink="/produccion/referencias/prensa-producto" routerLinkActive="active" class="nav-subitem" title="Prensa Producto">
                <div class="subitem-icon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg></div>
                <span class="item-label">Prensa Producto</span>
              </a>
              <a routerLink="/produccion/referencias/producto-terminado" routerLinkActive="active" class="nav-subitem" title="Producto Terminado">
                <div class="subitem-icon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/></svg></div>
        ...
        <ng-container *ngIf="(activeModule$ | async) === 'REPORTES HC'">
          ...
          <!-- Etiquetado -->
          <a routerLink="/reportes-hc/etiquetado" routerLinkActive="active" class="nav-item" title="Etiquetado">
            <div class="item-icon"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" x2="7.01" y1="7" y2="7"/></svg></div>
