  ...
  template: `
    <div class="module-page animate-move-up" style="padding: 1.5rem 2.5rem; background: #fff; min-height: calc(100vh - 64px); position: relative;">
      <header style="margin-bottom: 2rem;">
        <h1 style="font-size: 1.6rem; font-weight: normal; color: #1e293b; margin: 0 0 0.2rem 0;">Producto Terminado</h1>
        <nav style="font-size: 0.75rem; color: #94a3b8;">Producción › Referencias › Producto Terminado</nav>
      </header>
