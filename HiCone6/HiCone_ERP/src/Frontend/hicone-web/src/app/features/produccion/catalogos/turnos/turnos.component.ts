...
@Component({
  ...
  template: `
    <div class="module-page animate-move-up" (click)="closeAllDropdowns()">
      ...
      <!-- Encabezado -->
      <header style="display: flex; flex-direction: column; gap: 1rem; margin-bottom: 1.5rem;">
        <div>
...
export class TurnosCatalogoComponent implements OnInit {
  ...
  clearFilters() { this.searchText.set(''); this.colFilterNombre = ''; this.currentPage.set(1); this.showFilterOptions.set(false); }
  saveFilter()   { this.showFilterOptions.set(false); }
